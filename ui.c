...
void ui_event_Label_Cut_1(lv_event_t * e);
...
void ui_Audio_Player_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_Slider_group_left, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_Cut_1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_add_flag(ui_BTN_Cut_Left, LV_OBJ_FLAG_CHECKABLE);     /// Flags
    ...
    lv_obj_clear_flag(ui_Cut_3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_add_flag(ui_BTN_Cut_Left1, LV_OBJ_FLAG_CHECKABLE);     /// Flags
    ...
    lv_obj_clear_flag(ui_Slider_group_right, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_clear_flag(ui_Center_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_height(ui_Play, LV_SIZE_CONTENT);    /// 128
    ...
    lv_obj_add_flag(ui_BTN_Play, LV_OBJ_FLAG_CHECKABLE);     /// Flags
    ...
    lv_obj_clear_flag(ui_Indicator_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_add_flag(ui_EQ_group, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_EQ_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_add_flag(ui_Tempo_group, LV_OBJ_FLAG_HIDDEN);     /// Flags
    lv_obj_clear_flag(ui_Tempo_group, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
